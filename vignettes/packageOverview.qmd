...
We began by examining the real-world environmental exposure dataset derived from the cohort study led by Lucchini and colleagues. The dataset comprises measurements of five key metal concentrations in children---Cadmium, Mercury and Arsenic from urine, Lead, and Selenium from blood and Manganese from hair, along with corresponding intelligence quotient (IQ) scores, evaluated using the Wechsler Intelligence Scale for Children (WISC-IV), a standardised instrument for assessing children's Full-Scale IQ (FSIQ)[@grizzle2011; @renzetti2021].
