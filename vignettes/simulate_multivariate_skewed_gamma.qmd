...
# View the first few rows of the normal and Gamma samples
head(norm_samples)
head(gamma_samples)
```
...
```{r}
# Plot the density of the first variable for both normal and Gamma-transformed data
par(mfrow = c(2, 1))

# Density of normal samples (first variable)
plot(density(norm_samples[, 1]), main = "Density of Normal Samples (Variable 1)", col = "blue")

# Density of Gamma-transformed samples (first variable)
plot(density(gamma_samples[, 1]), main = "Density of Gamma Transformed Samples (Variable 1)", col = "red")
