...
variablePlot <- bkmrAnalysisData_df %>%
...
The data used in this study is sourced from the Study conducted by Dr. Lucchini of FIU, which includes information on children's IQ scores, metal concentrations (Cadmium, Mercury, Arsenic, Lead, and Manganese), and gender. The dataset was pre-processed to remove missing values, and only the relevant variables---IQ, metal concentrations, and gender---were retained for analysis.
